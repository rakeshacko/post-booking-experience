...
export const WAIT_STEPS: readonly WaitStep[] = [
  {
    ...
    today: {
      ...
      metric: "A few hours",
      metricNote: "manual intervention",
    ...
    automated: {
      ...
      actor: "Instant e-KYC",
      steps: [
        "PAN checked instantly against the NSDL database — a planned integration",
        "Aadhaar confirmed through DigiLocker",
        "An ML check flags only genuine fraud risks to a human",
      ],
      metric: "~30 seconds",
      metricNote: "instant & automatic",
      tags: ["DigiLocker", "NSDL · planned", "Fraud-checked"],
    },
    gain: "Manual → instant",
    routeMatchers: [
  ...
  },
  {
    ...
    today: {
      actor: "Dealer + RTO",
      steps: [
        "The dealer files your registration with the RTO on the Vahan portal",
        "Road tax is paid and your number plate (HSRP) is arranged",
        "You wait out the RTO’s few-day SLA with no real visibility",
      ],
      metric: "2–3 working days",
      metricNote: "and opaque to you",
      tags: ["Dealer-run", "Opaque"],
    },
    automated: {
      method: "Vahan / Parivahan integration",
      kind: "govrail",
      actor: "Live registration tracking",
      steps: [
        "We file and pay the road tax through the Vahan rails ourselves",
        "Every step is tracked live, end to end",
        "Your RC and number arrive the moment the RTO issues them",
      ],
      metric: "Live-tracked",
      metricNote: "you watch, not chase",
      tags: ["Vahan", "Live status"],
    },
    gain: "Opaque → tracked live",
