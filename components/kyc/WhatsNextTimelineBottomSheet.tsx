...
export function WhatsNextTimelineBottomSheet({
  ...
  return (
    <div className="fixed inset-0 z-[100]">
      ...
      />
      <div
        className={`absolute bottom-0 left-1/2 z-10 flex max-h-[90dvh] w-full max-w-[640px] -translate-x-1/2 flex-col overflow-y-auto rounded-t-[24px] bg-white shadow-[0_-8px_24px_rgba(0,0,0,0.12)] transition-transform duration-[280ms] ease-out motion-reduce:translate-y-0 motion-reduce:transition-none ${
      ...
      >
        ...
        <div className="mt-6 px-5 pb-[max(1.25rem,env(safe-area-inset-bottom))]">{children}</div>
      </div>
    </div>
  );
}
