  ...
  if (cancelled) {
    return (
      <ConciergeTurnShell
        says={[
          "It's done, Sharath.",
          `${formatInr(refundInr)} is on its way back to your account, in 5 to 7 business days. I'm sorry this one didn't work out. Whenever you're ready to try again, you know where I am.`,
        ]}
        artifact={refundCard(
          "Refund initiated",
    ...
    <>
      <ConciergeTurnShell
        says={
          ourFailure
            ? [
                ...
                "We couldn't hold up our side, so no rule applies to you. All of what you've paid comes back. I'm sorry, Sharath. Whenever you're ready to try again, I'd love another shot.",
              ]
            : secondChange
            ? [
                "A second change means starting over, Sharath.",
                "You've used your one change, and that's the line in the policy I can't move. Changing again works as a cancel and rebook: half of what you've paid is held back, and you start fresh with the car you actually want. Your call entirely.",
              ]
            : postConfirmation
              ? [
                  "Before I cancel anything, Sharath.",
                  "We're past the lock point, so cancelling holds back half of everything you've paid. That's the one rule I can't bend. If it's the car that's wrong, a colour or model change costs just ₹5,000. If it's anything else, talk to me first. I can usually fix it.",
                ]
              : [
        ...
        artifact={refundCard(
          ...
          "Refunds land in 5–7 business days. This math is final, with no surprises later."
        )}
        replies={[
          {
            label: ourFailure
        ...
        callLabel="Want to talk first? I can call you"
        showMenu={false}
      />
